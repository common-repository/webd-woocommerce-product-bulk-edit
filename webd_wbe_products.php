...
class WebdWoocommerceBulkEditProducts{
	...
	?>
		...
		if( empty( $posts ) ) {
				...
				<form name='editProductDisplay' id='editProductDisplay' method='post' action= "<?php echo admin_url( 'admin.php?page=webd-woocommerce-bulk-edit&tab=main' ); ?>" >
					<table class='wp-list-table widefat fixed table table-bordered'>	
						...
						<?php if($_REQUEST['vocabularySelect']){	?>		
							...
							<tr>
								<td>Products Per Page </td><td><input type='number' min="1" max="100" style='width:100%;' required name='posts_per_page' id='posts_per_page' placeholder='100 max'/></td><td></td><td></td>
							</tr>
			...
			$query = new WP_Query( array(
				...
				<div class='table-wrapper' ><div class='table table-bordered convertToTable'>			
							...
							if ( $product->is_type( 'simple' ) ) {							
								?>						
								<form method='post' action= "<?php echo admin_url( 'admin.php?page=webd-woocommerce-bulk-edit&tab=main&action=update' ); ?>" name='single_edit_list' class='single_edit_list'>
								<div>
								...
								<div><input type='text' name='post_title' value="<?php esc_attr(the_title()) ;?>" /></div>
								<?php } ?>
							...
							}//else print "<p class='warning'>For variable products please upgrade to <a  target='_blank'  href='https://webdeveloping.gr/product/woocommerce-product-bulk-editing-pro'>PRO VERSION</a></p>";
						}//end while
				print "</div></div></div>";	
				
			}else print "<p class=' error'>No Simple Product Found. For variable products please upgrade to <a  target='_blank'  href='https://webdeveloping.gr/product/woocommerce-product-bulk-editing-pro'>PRO VERSION</a></p>";//end if
	...
	public function updateMassiveForm(){
		?><div>
			<form name='updateMassive' id='updateMassive' method='post'>
